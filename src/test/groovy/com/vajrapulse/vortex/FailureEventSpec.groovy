...
class FailureEventSpec extends Specification {
    ...
    def "should create failure event with data and error"() {
        ...
        when:
        def event = new com.vajrapulse.vortex.results.FailureEvent<>("test-data", error)
    ...
    def "should handle null data"() {
        ...
        when:
        def event = new com.vajrapulse.vortex.results.FailureEvent<>(null, error)
    ...
    def "should handle null error"() {
        when:
        def event = new com.vajrapulse.vortex.results.FailureEvent<>("test-data", null)
    ...
    def "should handle different exception types"() {
        ...
        when:
        def events = exceptions.collect { new com.vajrapulse.vortex.results.FailureEvent<>("data", it) }
